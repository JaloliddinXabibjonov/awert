...
public class ArticleController {
    ...
    public HttpEntity<ApiResponse> save(@RequestParam String lastName, @RequestParam String firstName, @RequestParam String description,@RequestParam  String author,@RequestParam  String titleArticle,@RequestParam  Integer categoryId,@RequestParam  boolean publicOrPrivate, @RequestParam  UUID userId, @RequestPart MultipartFile file) throws IOException {
        ApiResponse apiResponse ;

        System.out.println("bu  user     "+userId);
//        try {
            apiResponse = articleService.addArticle(lastName,firstName, description, author, titleArticle, categoryId, publicOrPrivate,  userId, file);
//        } catch (IOException e) {
