...
public class ArticleService {
    ...
    public ApiResponse addArticle(String lastName, String firstName, String description, String author, String titleArticle, Integer categoryId, boolean publicOrPrivate, UUID userId, MultipartFile file) throws IOException {
...
//        }
        ...
        if (category.isPresent()) {
            ...
            article.setAdmin(userRepository.getById(userId));
//            article.setPrice();
...
//        Article article = articleRepository.findByConfirmTrueAndId(getUsersRoleId.getArticleId());
    ...
    public ApiResponse getNewOllArticle() {
        ...
        return new ApiResponse("new article", true, articles);
    }
